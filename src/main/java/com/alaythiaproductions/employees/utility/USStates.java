package com.alaythiaproductions.employees.utility;
...
public class USStates {
    ...
    public final static List<String> listOfUSStateCode = new ArrayList<>(mapOfUSStates.keySet());

    public final static List<String> listOfUSStateName = new ArrayList<>(mapOfUSStates.values());
